 ...
 */
export type ObserverObject<T extends unknown[] = unknown[]> = {
    update?: (...args: T) => void;
};
/**
 ...
 */
declare class DualObserverSubject<T extends unknown[] = unknown[]> {
    private _observers;
...
//# sourceMappingURL=DualObserverSubject.d.ts.map