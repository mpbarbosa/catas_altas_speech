 ...
 */
declare class VoiceSelector {
    primaryLang: string;
    fallbackLangPrefix: string;
    /**
     ...
     * const ptBRVoices = selector.filterByLanguage(voices, 'pt-BR');
     */
    filterByLanguage(voices: SpeechSynthesisVoice[], langCode: string): SpeechSynthesisVoice[];
    /**
     ...
     */
    filterByLanguagePrefix(voices: SpeechSynthesisVoice[], langPrefix: string): SpeechSynthesisVoice[];
    /**
     ...
     */
    _selectBestVoice(voices: SpeechSynthesisVoice[]): SpeechSynthesisVoice | null;
    /**
     ...
     */
    getVoiceInfo(voice: SpeechSynthesisVoice | null): {
        type: string;
        name: string;
        lang: string;
        isLocal: boolean;
