...
class SpeechSynthesisManager {
    ...
    startVoiceRetryTimer() {
        ...
        this.voiceRetryTimer = timerManager.setInterval(() => {
            ...
            const brazilianVoice = voices.find(voice => voice.lang && voice.lang.toLowerCase() === SPEECH_CONFIG.primaryLanguage);
            if (brazilianVoice) {
    ...
    startQueueTimer() {
        ...
        this.queueTimer = timerManager.setInterval(() => this.processQueue(), this.independentQueueTimerInterval, 'speech-synthesis-queue');
    }
    /**
...
//# sourceMappingURL=SpeechSynthesisManager.js.map