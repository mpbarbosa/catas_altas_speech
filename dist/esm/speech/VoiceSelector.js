...
class VoiceSelector {
    ...
    filterByLanguage(voices, langCode) {
        ...
        return voices.filter(voice => voice.lang && voice.lang.toLowerCase() === targetLang);
    }
    /**
    ...
    filterByLanguagePrefix(voices, langPrefix) {
        ...
        return voices.filter(voice => voice.lang && voice.lang.toLowerCase().startsWith(targetPrefix));
    }
    /**
