...
<script type="module">
  import SpeechSynthesisManager, {
    SPEECH_PRIORITY,
  } from 'https://cdn.jsdelivr.net/gh/mpbarbosa/catas_altas_speech@0.1.3/dist/esm/index.js';
...
Pin a tag (`@0.1.3`) for stability, or use `@latest` to always get the newest
